...
_G.packer_plugins = {
  ...
  catppuccin = {
    loaded = true,
    path = "/home/bes/.local/share/nvim/site/pack/packer/start/catppuccin",
  ...
  ["nvim-lsp-installer"] = {
    loaded = true,
    path = "/home/bes/.local/share/nvim/site/pack/packer/start/nvim-lsp-installer",
  ...
  ["which-key.nvim"] = {
    loaded = true,
    path = "/home/bes/.local/share/nvim/site/pack/packer/start/which-key.nvim",
